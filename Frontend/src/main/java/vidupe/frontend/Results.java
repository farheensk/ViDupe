...
public class Results extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (blob != null && blob.exists()) {
            ...
            if (duplicateVideosList != null && duplicateVideosList.getDuplicateVideosList().size() > 0) {
                for (List<VideoHashesInformation> duplicateGroup : duplicateVideosList.getDuplicateVideosList()) {
                    ...
                    for (VideoHashesInformation video : duplicateGroup) {
                        String url = "https://drive.google.com/thumbnail?id=" + video.getVideoID();
                        out.println("<td>");
                ...
                out.println("</tbody></table>" +
                        "<input type='submit' name='submit' value='permanently delete videos'>" +
                        "</input>" +
                        "</form>");
            } else {
