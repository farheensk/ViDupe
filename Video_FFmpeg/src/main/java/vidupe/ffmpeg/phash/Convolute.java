...
public class Convolute
{
    ...
    public static ArrayData[] getArrayDatasFromImage(BufferedImage inputImage) throws IOException
    {
    ...
    public static BufferedImage writeOutputImage(ArrayData[] redGreenBlue) throws IOException
    {
